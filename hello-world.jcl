//DEVOPS JOB,'TEST JCL HELLO WORLD',MSGCLASS=A
//*
//*Use the ICY control program to compile cobol
...
//*
//JSTEP02  EXEC PGM=IEWBLINK,REGION=0M,COND=(0,LT)
//*
...
//*
//SYSLMOD  DD DSN=&SYSUID.COBOL.LOADLIB(HWORLD),
//            SPACE=(1024,(50,20,1)),
//            DSNTYPE=LIBRARY,
//            DISP=(MOD,CATLG,KEEP)
//*
//SYSPRINT DD SYSOUT=*
//*
//JSTEP03  EXEC PGM=HWORLD,COND=(0,LT)
//*
